...
export function DetailsButtomWarehauseType ({ WarehauseType }) {
  ...
  const handleOpen = () => {
    ...
    dispatch(setDetailsData({ detailsData: WarehauseType }))
  }
  // ?
...
export default DetailsWarehauseType
