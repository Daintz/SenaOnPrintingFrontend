...
import { useGetAllWarehauseTypesQuery } from '../../context/Api/Common'
import { UpdateButtomWarehauseType } from './UpdateWarehausetype'
import { ChangeStateButtonWarehauseType } from './ChangeStateWarehausetype'
import { CreateButtomWarehauseType } from './CreateWarehausetype'
import { DetailsButtomWarehauseType } from './DetailsWarehausetype'

const ListWarehauseType = () => {
  ...
  const { data: dataApi, refetch } = useGetAllWarehauseTypesQuery()
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 grid grid-cols-3  place-content-center" key={5}>
                      <DetailsButtomWarehauseType
                        WarehauseType={row.original}
                      />
                      <UpdateButtomWarehauseType
                        WarehauseType={row.original}
                      />
                      <ChangeStateButtonWarehauseType
                        WarehauseType={row.original}
                      />
                    </td>
                  </tr>
...
export default ListWarehauseType
