import { usePutFinishByIdMutation } from '../../context/Api/Common'
...
function Updatefinish () {
  ...
  const [updatefinish, { error, isLoading }] = usePutFinishByIdMutation()

  const handleSubmit = async values => {
    if (isLoading) return <Spinner />
    if (error) return <Error type={error.status} message={error.error} />
    await updatefinish(values)
...
export function UpdateButtomFinish ({ finish }) {
