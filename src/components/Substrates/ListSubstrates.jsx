...
import { useGetAllSubstratesQuery } from '../../context/Api/Common'
...
const ListSubstrates = () => {
  ...
  const { data: dataApi, refetch } = useGetAllSubstratesQuery()
