...
import { useGetAllGrammageCalibersQuery } from '../../context/Api/Common'
import { UpdateButtonGrammageCaliber } from './UpdateGrammageCaliber'
import { ChangeStateButtonGrammageCaliber } from './ChangeStateGrammageCaliber'
import { CreateButtonGrammageCaliber } from './CreateGrammageCaliber'
import { DetailsButtonGrammageCaliber } from './DetailsGrammageCaliber'

const ListGrammageCaliber = () => {
  ...
  const { data: dataApi, refetch } = useGetAllGrammageCalibersQuery()
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 grid grid-cols-3  place-content-center" key={5}>
                      <DetailsButtonGrammageCaliber
                        grammageCaliber={row.original}
                      />
                      <UpdateButtonGrammageCaliber
                        grammageCaliber={row.original}
                      />
                      <ChangeStateButtonGrammageCaliber
                        grammageCaliber={row.original}
                      />
                    </td>
                  </tr>
...
export default ListGrammageCaliber
