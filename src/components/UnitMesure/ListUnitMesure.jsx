...
import { useGetAllUnitUnitMesureQuery } from '../../context/Api/Common'
import  { UpdateButtomUnit } from './UpdateUnitMesure'
import { ChangeStateButtonUnit } from './ChangeStateUnitMesure'
import { CreateButtomUnit } from './CreateUnitMesure'
import { DetailsButtomUnit } from './DetailsUnitMesure'
...
const ListUnit = () => {
  ...
  const { data: dataApi, refetch } = useGetAllUnitUnitMesureQuery()
  ...
  const columns = useMemo(() => [
    ...
    { Header: 'Abreviacion  ', accessor: 'abbreviation' },
    { Header: 'Tipo ', accessor: 'type' },
    { Header: 'Factor de conversacion', accessor: 'conversionFactor' },
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 grid grid-cols-3  place-content-center" key={5}>
                      <DetailsButtomUnit
                        unitMesure={row.original}
                      />
                      <UpdateButtomUnit
                        unitMesure={row.original}
                      />
                      <ChangeStateButtonUnit
                        unitMesure={row.original}
                      />
                    </td>
                  </tr>
