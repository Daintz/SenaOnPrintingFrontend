...
import { useGetAllTypeServicesQuery } from '../../context/Api/Common'
...
const ListTypeServices = () => {
  ...
  const { data: dataApi, refetch } = useGetAllTypeServicesQuery()
