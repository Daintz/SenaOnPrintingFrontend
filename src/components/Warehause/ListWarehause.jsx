          ...
          ? (
            <>
              <div className="relative bg-white py-10 px-20 shadow-xl mdm:py-10 mdm:px-8">
                ...
                <p className="text-center text-xl">Para empezar a visualizar la información debes de registrar una bodega </p>
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="px-6 py-4 grid grid-cols-3  place-content-center" key={5}>
                                <DetailsButtomWarehause
                                  warehause={row.original}
                                />
                                <UpdateButtomWarehause
                                  warehause={row.original}
                                />
                                <ChangeStateButtonWarehause
                                  warehause={row.original}
                                />
                              </td>
                            </tr>
