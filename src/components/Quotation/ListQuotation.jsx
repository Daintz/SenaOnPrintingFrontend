...
import { useGetAllQuotationClientsQuery , useGetAllQuotationClientDetailsQuery } from '../../context/Api/Common'
...
const ListQuotation = () => {
  ...
  const columns = useMemo(() => [
    ...
    { Header: 'Estado Cotizacion', accessor: 'quotationStatus'}
  ], [])
  ...
  const data2 = useMemo(() => (dataApi2 || []), [dataApi2])
