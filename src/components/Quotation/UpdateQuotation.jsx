import { usePutQuotationClientByIdMutation, usePutQuotationClientDetailByIdMutation } from '../../context/Api/Common'
...
function updateQuotation () {
  ...
  const [updateQuotationClient, { error: clientError, isLoading: clientIsLoading }] = usePutQuotationClientByIdMutation()
  const [updateQuotationClientDetail, { error: detailError, isLoading: detailIsLoading }] = usePutQuotationClientDetailByIdMutation()
  ...
  const handleSubmit = async (values) => {
    ...
    const response = await updateQuotationClient(values)
    console.log(response)
    const response2 = await updateQuotationClientDetail(values)
