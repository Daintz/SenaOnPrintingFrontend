...
import { DetailsButtonRole } from './DetailsRole'
import { ChangeStateButtonRole } from './ChangeStateRole'
...
const ListRole = () => {
  ...
  const generatePDF = useReactToPrint({
    ...
    documentTitle: 'Informe de Roles'
  })
  ...
  const { data: dataApi, refetch } = useGetAllRolesQuery()
