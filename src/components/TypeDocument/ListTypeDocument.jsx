...
import { DetailsButtonTypeDocument } from './DetailsTypeDocument'
import { ChangeStateButtonTypeDocument } from './ChangeStateTypeDocument'
...
import ReportTypeDocument from './ReportTypeDocument'
...
const ListTypeDocument = () => 
{
  ...
  const generatePDF = useReactToPrint({
    ...
    documentTitle: 'Informe de Tipos de Documento'
  })
  ...
  const { data: dataApi, refetch } = useGetAllTypeDocumentsQuery()
  ...
  const columns = useMemo(() => [
    ...
    { Header: 'Abreviación', accessor: 'abbreviation' },
    {
      Header: 'Estado',
      accessor: 'statedAt',
      Cell: ({ value }) => (value
  ...
  return (
    <>
      <div className='hidden'>
        <div ref={tablePDF}>
          <ReportTypeDocument dataApi={dataApi}/>
        </div>
      </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 grid grid-cols-3  place-content-center" key={5}>
                        <DetailsButtonTypeDocument
                          typeDocument={row.original}
                        />
                        <UpdateButtomTypeDocument
                          typeDocument={row.original}
                        />
                        <ChangeStateButtonTypeDocument
                          typeDocument={row.original}
                        />
                      </td>
                    </tr>
