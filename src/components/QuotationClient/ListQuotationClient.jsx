...
import { useGetAllQuotationClientsQuery } from '../../context/Api/Common'
import { UpdateButtomQuotationClient } from './UpdateQuotationClient'
import { ChangeStateButtonQuotationClient } from './ChangeStateQuotationClient'
import { CreateButtomQuotationClient } from './CreateQuotationClient'
import { DetailsButtomQuotationClient } from './DetailsQuotationClient'

const ListQuotationClient = () => {
  ...
  const { data: dataApi, refetch } = useGetAllQuotationClientsQuery()
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 grid grid-cols-3  place-content-center" key={5}>
                      <DetailsButtomQuotationClient
                        quotationclient={row.original}
                      />
                      <UpdateButtomQuotationClient
                        quotationclient={row.original}
                      />
                      <ChangeStateButtonQuotationClient
                        quotationclient={row.original}
                      />
                    </td>
                  </tr>
...
export default ListQuotationClient
