...
function ChangeStateSupplyDetails ({ supplyDetails }) {
  ...
  const handleSubmit = async () => {
    ...
    dispatch(closeModal())
    toast.success('Loteo de insumos cambio de estado con exito')
  }
  ...
  return (
    <>
      ...
      <p className="text-lg">¿Estas seguro de <b>cambiar de estado</b> este loteo de insumo?</p>
