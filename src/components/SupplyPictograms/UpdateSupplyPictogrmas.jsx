...
function UpdateSupplyPictograms () {
  ...
  const inputs = [
    { key: 0, name: 'code', title: 'Codigo del pictograma', type: 'string', placeholder: 'codigo' },
    {key: 1, name: 'name', title:'Nombre del Pictograma', type: 'text', placeholder: 'nombre'  },
    {key: 2, name: 'description',title:'descripcion del Pictograma',type: 'text', placeholder: 'descripción'},
    {key:3,name: 'pictogramFile',title:'Documento pictograma', type: 'text', placeholder: 'Documento pictograma'}
  ...
  return (
    <Formik
      initialValues={{
        ...
        pictogrmFile: editingData.pictogrmFile
      }}
      onSubmit={(values) => {
        handleSubmit(values)
      }}
