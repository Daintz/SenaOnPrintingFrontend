...
function SubstrateModal ({ isEditingInfo, isEditing, setIsEditingInfo, get, setIsOpen }) {
  ...
  const handleSubmitCreate = async e => {
    ...
    try {
      await clientAxios.post('/Substrates', dataForm)
      get()
      setIsOpen(false)
    } catch (err) {
      console.log(err)
  ...
  const handleSubmitEdit = async e => {
    ...
    try {
      await clientAxios.put(`/Substrates/${isEditingInfo.id}`, isEditingInfo)
      get()
      setIsOpen(false)
    } catch (err) {
      console.log(err)
