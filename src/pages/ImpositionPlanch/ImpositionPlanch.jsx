...
import ChangeStateImpositionPlanch from '../../components/ImpositionPlanch/ChangeStateImpositionPlanch'
  ...
  return (
    <div className="border-gray-200 border-dashed">
      <div className="overflow-x-auto">
        ...
        <NewModal>
          {action === 'editing' ? <UpdateImpositionPlanch /> : undefined}
          {action === 'creating' ? <CreateImpositionPlanch /> : undefined}
          {action === 'changing' ? <ChangeStateImpositionPlanch /> : undefined}
        </NewModal>
      </div>
    </div>
